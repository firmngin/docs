...
stateDiagram-v2
    [*] --> Available: Stock is set for this device
    Available --> Reserved: Order is created
    Reserved --> Dispensed: Payment is confirmed
    Reserved --> Available: Order is cancelled
    Reserved --> Available: Payment expires
    Dispensed --> [*]
```
