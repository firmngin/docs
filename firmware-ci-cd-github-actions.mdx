...
| `arduino-sketch` | No | auto-detect | Sketch **folder** name (for example `my-device`). |
...
- Use `FolderName/FolderName.ino` layout.
- Set `arduino-sketch` to the **folder name** (for example `my-device`).
